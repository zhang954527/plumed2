...
public:
  ...
  double calculate_gpu( const std::vector<Vector>& pos, ReferenceValuePack& myder, const bool& squared ) const ;
  virtual double calc( const std::vector<Vector>& pos, ReferenceValuePack& myder, const bool& squared ) const=0;
  virtual double calc_gpu( const std::vector<Vector>& pos, ReferenceValuePack& myder, const bool& squared ) const=0;
};
