...
double SimpleRMSD::calc_gpu( const std::vector<Vector>& pos, af::array& pos_device, const std::vector<int> &indexes_device, ReferenceValuePack& myder, const bool& squared) const {
  double d = 0.01, ret;
  ret = d*d;
  return ret;
}

double SimpleRMSD::calc( const std::vector<Vector>& pos, ReferenceValuePack& myder, const bool& squared, const bool& gpu ) const {
